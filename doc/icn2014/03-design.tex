...
\endgrammar
\end{mdframed}
\caption{NDN-to-IP application-layer encoding grammar.}
\end{figure*}
...
\caption{The top figure shows the deployment strategy with a fixed global directory that exists merely for obtaining bridge addresses, and the bottom figure shows the deployment strategy in which a distributed directory coordinates group key agreement protocols between all bridges.}
\end{center}
\end{figure}
