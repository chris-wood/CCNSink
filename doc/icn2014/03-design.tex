...
\begin{compactenum}
	...
	\item $G$ builds the interest $\mathsf{prefix}/\mathsf{id}/\mathsf{nonce}/\mathsf{data}$ and issues the interest to the NDN network.
\end{compactenum}
%
